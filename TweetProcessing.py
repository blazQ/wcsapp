...
# TODO: Riorganizzare le funzioni in delle classi per migliorare l'ordine del codice.

def get_tweets(hashtags, max_results_bound: int = 100, bound: int = 10):
...
def filter_tweets(unfiltered_tweets, date_filter_lower=None, date_filter_upper=None, ad_filter: dict = None):
    filtered_tweets = []
...
write_tweets_csv(filtered_tweets_test, 'tweet.csv')
